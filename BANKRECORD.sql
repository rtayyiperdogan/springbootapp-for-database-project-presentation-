...
'00089','Bursa/Turkey','1234567800120001','Drawing Account',5000,1200,400,1.15,'2021-05-05','2021-05-12',1900,'1597538536245480',1,0,75000,'2019-05-07','Housing Rental Payment',
...
'00089','Bursa/Turkey','9876543219876543','Drawing Account',5000,1200,400,1.15,'2021-05-05','2021-05-12',1900,'5597538536245480',1,0,63000.5,'2021-02-12','Office Rental Payment',
'TR605656165320051615671235','56561','Tokat/Turkey','5320051615671235','Euro');

insert into TransactionInformation values('14785236936','abcd12','Ali Ege','Fakı','05435153821','ali2@outlook.com','Antalya/Turkey','1963','789','TR760008908876543219876543',
'00089','Bursa/Turkey','9876543219876543','Drawing Account',5000,1200,400,1.15,'2021-05-05','2021-05-12',1900,'5597538536245480',1,0,59000,'2021-01-05','Other Rental Payments',
...
'36542','İzmir/Turkey','2589631456987423','Credit Card',8000,500,200,1.15,'2021-05-11','2021-05-15',1200,'8532156820025311',0,0,1200,'2021-02-12','E-Commerce Payment',
...
'65654','Mersin/Turkey','4236589200354456','Drawing Account',7500,300,120,1.45,'2021-08-08','2021-08-15',500,'1661255233698589',0,1,1200,'2021-02-24','Worker Payment',
...
'20456','Aydın/Turkey','5615623687165518','Credit Card',8700,5500,2200,1.45,'2021-11-15','2021-11-19',450,'4656548956223054',1,1,2500,'2021-03-31','Commercial Payment',
'TR760008908876543219876543','00089','Bursa/Turkey','9876543219876543','TL');

insert into TransactionInformation values('26532145621','112233','Recep Tayyip','Erdoğan','05050235521','rte@hotmail.com','Eskişehir/Turkey','4612','782','TR654561225326984263256356',
'45612','Eskişehir/Turkey','5326984263256356','General Credit',15000,7000,2800,1.39,'2021-08-13','2021-08-20',800,'3256987453215698',0,1,352.99,'2019-12-24','Individual Payment', 'TR761525401587463259874236','15254','İstanbul/Turkey','1587463259874236','Euro');
...
'25896','Van/Turkey','0234569875012033','Deposit Account',9000,2000,800,1.39,'2021-05-15','2021-05-24',120,'1589632145625025',1,0,4244.45,'2021-04-23','Com. Financial Investment',
...
'12325','Balıkesir/Turkey','0345619768342551','Checking Account',1200,7000,2800,1.39,'2021-08-19','2021-08-25',80,'1568971456112265',1,0,2527.52,'2019-08-30','Ind. Financial Investment',
...
'25654','Bayburt/Turkey','6545612365422565','General Credit',3000,4000,1600,2,'2021-12-31','2021-11-07',1200,'6552324565121454',0,0,2527.52,'2019-05-19','Training Payment',
...
'56561','Tokat/Turkey','5320051615671235','General Credit',4000,8000,3200,2,'2021-07-05','2021-07-12',1600,'4545623051644204',1,0,3520,'2019-07-15','Contribution Payment',
'TR773654212589631456987423','36542','İzmir/Turkey','2589631456987423','Coin');

alter table TransactionInformation add primary key(TransactionID);
...
select distinct b. CustomerID,b.AppPassword,b.CustomerName
,b.CustomerSurname,b.CustomerPhoneNumber
,b.CustomerEmail,b.CustomerAddress,b.CardPassword
,b.CVC,b.IBAN,b.BankID,b.BranchAddress
,b.AccountNo,b.AccountType,b.AvailableCardLimit
,b.CurrentDebt,b.MinimumPaymentAmount, b.InterestRate
,b.CutoffDate,b.LastPaymentDate,b.CreditScore
,b.CardNumber,b.ContactlessPayment,b.OnlinePayment
,b.CurrencyType
from TransactionInformation b
...
c.BranchAddress,c.AccountNo,c.AccountType,c.AvailableCardLimit,c.CurrentDebt,c.MinimumPaymentAmount, c.InterestRate,
...
a.BranchAddress,a.AccountType,a.AvailableCardLimit,a.CurrentDebt,a.MinimumPaymentAmount, a.InterestRate,
...
select distinct a.CurrentDebt,a.MinimumPaymentAmount, a.InterestRate
from AccountDetails a
alter table AccountDetails add foreign key (CurrentDebt) references AmountofPayment(CurrentDebt)
alter table AccountDetails drop column MinimumPaymentAmount, InterestRate
